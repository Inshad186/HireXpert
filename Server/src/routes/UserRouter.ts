...
router.post("/changeProfile",verifyTokenMiddleware,allowRoles("client","freelancer"), upload.single("profileImage"), userController.updateProfileImage.bind(userController))
