...
export interface IAdminController {
    ...
    getOrdersList(req: Request, res: Response, next:NextFunction) : Promise<void>;
    blockUser(req:Request, res:Response, next:NextFunction): Promise<void>;
    addCategories(req:Request, res:Response, next:NextFunction) : Promise<void>
    ...
    deleteCategoryAndSkills(req:Request, res:Response, next:NextFunction) : Promise<void>
}